...
Graduation year &  2022 &   0.7 &  2021 &  2023 &  2021 &  2023 \\[4pt]
...
\scriptsize
\item \textit{Notes:} Female, Married, and Has children are binary (0/1) indicators; their means equal the share of the sample with that characteristic. $p_5$ and $p_{95}$ for wage variables are the winsorisation thresholds used in Table~\ref{tab:regsw}. Wages standardised to monthly GHC equivalents using a 40-hour, 5-day working week.
\end{tablenotes}
\end{threeparttable}
\end{table}
