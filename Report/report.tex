...
\begin{abstract}
\noindent
This report summarizes preliminary findings from a baseline survey of 48 Ghanaian
...
All entries were algorithmically standardized  to a \textbf{monthly GHC equivalent}
...
Table~\ref{tab:regs} summarizes the direction and significance of notable
...
\begin{itemize}
    ...
    reference points for expected pay in the local graduate labor market.
...
algorithmic standardization procedure handles these cases, but some uncertainty
...
%─────────────────────────────────────────────────────────────────────────────
\section{Robustness: Winsorized Wages}
%─────────────────────────────────────────────────────────────────────────────
...
after winsorizing both wage outcomes at the 5th and 95th percentiles: values
...
Table~\ref{tab:regsw} reports the results. The winsorization affected 4 minimum-wage
