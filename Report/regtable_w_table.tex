\begin{table}[h!]
\centering
\caption{OLS Regression Results: Winsorised Wages (5th/95th Percentile)}
\label{tab:regsw}
...
$N$ & 48 & 48 & 44 & 44 \\
\bottomrule
\multicolumn{5}{l}{\footnotesize \textit{Note:} $+$ / $-$ indicates direction; ns = not significant.}\\
\multicolumn{5}{l}{\footnotesize *** $p$<0.01, ** $p$<0.05 (robust standard errors).}\\
\multicolumn{5}{l}{\footnotesize Salary excluded from all models (see Section~\ref{sec:notes}).}\\
\end{tabular}
\end{table}
